...
describe('teal player test', () => {
  ...
  testName = test.skip('mute-unmute-video', async() => {
    ...
    const pauseButton = await driver.wait(until.elementLocated(By.css('#unmuteTealSvg')), global.ELEMENT_TIMEOUT);
    ...
    const playButton = await driver.wait(until.elementLocated(By.css('#muteTealSvg')), global.ELEMENT_TIMEOUT);
